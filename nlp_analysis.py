...
Usage:
    nlp_analysis.py arg1 [--arg2 <key>]
    nlp_analysis.py (-h | --help)
    nlp_analysis.py --version
...
texts = get_texts(pdf_filename=pdf_name, path_to_directory=CONVERTED_PDF_IMAGE_DIR)    
